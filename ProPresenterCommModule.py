...
"""Modified for use by Brian Rodgers"""
...
class ProPresenterStageDisplayClientComms(threading.Thread):
    ...
    def __init__(self, host, port, password):
        ...
        # Start the thread
        super(ProPresenterStageDisplayClientComms, self).__init__()
    ...
    def sendCommand(self, msg):
        ...
        commandOut = (msg + "\r\n")
        self.sock.send(commandOut.encode('utf-8'))
